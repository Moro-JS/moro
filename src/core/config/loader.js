    ...
    const envConfig = {
        ...
        database: {
            ...
            mysql: process.env.MYSQL_HOST
                ? {
                    ...
                    connectionLimit: process.env.MYSQL_CONNECTION_LIMIT || process.env.MORO_MYSQL_CONNECTIONS,
                    acquireTimeout: process.env.MYSQL_ACQUIRE_TIMEOUT || process.env.MORO_MYSQL_ACQUIRE_TIMEOUT,
        ...
        modules: {
            ...
            rateLimit: {
                ...
                defaultRequests: process.env.DEFAULT_RATE_LIMIT_REQUESTS || process.env.MORO_RATE_LIMIT_REQUESTS,
                defaultWindow: process.env.DEFAULT_RATE_LIMIT_WINDOW || process.env.MORO_RATE_LIMIT_WINDOW,
                skipSuccessfulRequests: process.env.RATE_LIMIT_SKIP_SUCCESS || process.env.MORO_RATE_LIMIT_SKIP_SUCCESS,
                skipFailedRequests: process.env.RATE_LIMIT_SKIP_FAILED || process.env.MORO_RATE_LIMIT_SKIP_FAILED,
            },
            validation: {
        ...
        logging: {
            ...
            outputs: {
                ...
                webhook: {
                    enabled: process.env.LOG_WEBHOOK_ENABLED === 'true' || process.env.MORO_LOG_WEBHOOK === 'true',
                    url: process.env.LOG_WEBHOOK_URL || process.env.MORO_LOG_WEBHOOK_URL,
                    headers: parseJsonEnv(process.env.LOG_WEBHOOK_HEADERS || process.env.MORO_LOG_WEBHOOK_HEADERS, {}),
                },
            },
        },
        security: {
