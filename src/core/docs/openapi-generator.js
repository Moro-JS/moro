...
exports.defaultSecuritySchemes = exports.OpenAPIGenerator = void 0;
...
class OpenAPIGenerator {
    ...
    generateParameters(route) {
        ...
        if (route.validation?.params) {
            const paramSchema = (0, zod_to_openapi_1.zodToOpenAPI)(route.validation.params, this.options);
        ...
        if (route.validation?.query) {
            const querySchema = (0, zod_to_openapi_1.zodToOpenAPI)(route.validation.query, this.options);
        ...
        if (route.validation?.headers) {
            const headerSchema = (0, zod_to_openapi_1.zodToOpenAPI)(route.validation.headers, this.options);
    ...
    generateRequestBody(route) {
        ...
        const bodySchema = (0, zod_to_openapi_1.zodToOpenAPI)(route.validation.body, this.options);
...
function generateOpenAPIFromRoutes(routes, options) {
